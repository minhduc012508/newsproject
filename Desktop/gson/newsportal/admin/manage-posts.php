...
<td colspan="4" align="center"><h3 style="color:red">Không Tìm Thấy Bản Ghi</h3></td>
<tr>
<?php 
} else {
...
<td><a href="edit-post.php?pid=<?php echo htmlentities($row['postid']);?>"><i class="fa fa-pencil" style="color: #29b6f6;"></i></a> 
    &nbsp;<a href="manage-posts.php?pid=<?php echo htmlentities($row['postid']);?>&&action=del" onclick="return confirm('Bạn thực sự muốn xoá không?')"> <i class="fa fa-trash-o" style="color: #f05050"></i></a> </td>
 </tr>
<?php } }?>
