...
<div class="col-lg-12">
	<div class="card card-outline card-primary">
		...
		<div class="row">
			<div class="form-group">
				<label for="" class="control-label">Thêm ảnh</label>
		...
		<div class="row">
			<div class="form-group">
				<div class="custom-control custom-switch">
                  ...
                  <label class="custom-control-label" for="publishToggle">Công khai</label>
                </div>
			</div>
		</div>
        </form>
    	...
    	<div class="card-footer border-top border-info">
    		<div class="d-flex w-100 justify-content-center align-items-center">
    			<button class="btn btn-flat  bg-gradient-primary mx-2" form="manage-post">Lưu</button>
    			<button class="btn btn-flat bg-gradient-secondary mx-2" type="button" onclick="location.href='index.php?page=post_list'">Hủy bỏ</button>
    		</div>
    	</div>
	</div>
</div>
