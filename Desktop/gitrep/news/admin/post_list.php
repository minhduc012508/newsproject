	...
	<div class="card card-outline card-primary">
		<div class="card-header">
			<div class="card-tools">
				<a class="btn btn-block btn-sm btn-default btn-flat border-primary" href="./index.php?page=new_post"><i class="fa fa-plus"></i> Thêm Tin</a>
			</div>
		</div>
		<div class="card-body">
				...
				<tbody>
					...
					<tr>
						...
						<td class="text-center">
							<div class="d-block">
							<?php if($row['status'] == 0): ?>
								<span class="badge badge-secondary">Không công khai</span>
